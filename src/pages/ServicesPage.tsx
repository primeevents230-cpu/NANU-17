                  ...
                  >
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 hover:shadow-2xl transition-all duration-500 h-full flex flex-col">
                      ...
                      <div className="flex items-center justify-between pt-6 border-t border-gray-200">
                        <button className="text-[#e1b382] hover:text-[#c89666] font-medium flex items-center space-x-2 group-hover:translate-x-1 transition-transform">
                          <span>Learn More</span>
                          <ArrowRight size={18} />
                        </button>
                        <button className="bg-[#2d545e] hover:bg-[#12343b] text-white px-6 py-2 rounded-lg font-medium transition-colors">
                          Get Quote
                        </button>
                      </div>
                    </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-[#e1b382] px-8 py-4 rounded-lg font-medium hover:bg-gray-100 transition-colors">
