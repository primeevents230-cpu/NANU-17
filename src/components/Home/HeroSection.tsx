        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="bg-[#e1b382] hover:bg-[#c89666] text-white px-8 py-4 rounded-lg font-medium text-lg transition-all transform hover:scale-105 hover:shadow-xl">
                Get Started
              </button>
              <button className="flex items-center space-x-2 text-white border-2 border-white/30 hover:border-white/60 px-8 py-4 rounded-lg font-medium text-lg transition-all backdrop-blur-sm">
                <Play size={20} />
